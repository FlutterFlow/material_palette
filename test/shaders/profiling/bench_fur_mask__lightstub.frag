// BENCH VARIANT — DO NOT SHIP. Derived from lib/shaders/fur_planar_mask.frag.
// Edit: 4-light shading -> ambient only (normal+viewDir kept alive against DCE)
...
void main() {
    ...
    for (int i = 0; i < RAY_STEPS; i++) {
        ...
        V totalLight = ambient + 0.0001 * (normal + viewDir);
