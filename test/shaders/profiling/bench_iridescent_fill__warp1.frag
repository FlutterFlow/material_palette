// BENCH VARIANT — DO NOT SHIP. Derived from lib/shaders/iridescent_liquid.frag.
// Edit: 1 warpMap instead of 3 (chromatic aberration removed)
...
void main() {
    ...
    vec4 wmG = warpMap(warpUV, tw, stripeG);
    vec3 col = vec3(wmG.r, wmG.g, wmG.b);
